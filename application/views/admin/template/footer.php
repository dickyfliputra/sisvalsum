<footer class="footer">
    ...
    <script src="<?= base_url('assets/template/'); ?>assets/vendors/select2/select2.min.js"></script>
    <script src="<?= base_url('assets/template/'); ?>assets/vendors/typeahead.js/typeahead.bundle.min.js"></script>
    ...
    <script src="<?= base_url('assets/template/'); ?>assets/js/file-upload.js"></script>
    <script src="<?= base_url('assets/template/'); ?>assets/js/typeahead.js"></script>
    <script src="<?= base_url('assets/template/'); ?>assets/js/select2.js"></script>
